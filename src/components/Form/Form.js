...
const Form = ({ addPrompt }) => {
  ...
  return (
    <div className="form mt-9 flex justify-center">
      <form onSubmit={submitPrompt} className="shadow-xl p-5 rounded-md w-3/4">
        <div className="prompt-container mt-4">
          ...
          <div className="mt-1 rounded-md shadow-sm">
            <input
              ...
              id="prompt"
              name="prompt"
              placeholder="Who is Beyonce Knowles?"
          ...
          <div className="presets">
            <div className="temperature-container mt-3">
              <div className="flex justify-between">
                ...
                <span className="text-sm text-gray-500" id="temperature">
                  Optional
                </span>
              </div>
              <div className="mt-1">
                <Slider
                  ...
                  getAriaValueText={() =>
                    `Temperature: ${promptReq.temperature}`
                  }
                  marks
                  name="temperature"
                  min={0}
            ...
            <div className="token-container mt-3">
              <div className="flex justify-between">
                ...
                <span className="text-sm text-gray-500" id="tokens">
                  Optional
                </span>
              </div>
              <div className="mt-1">
